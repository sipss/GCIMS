...
#'
#' @details `gcims_baseline_removal` performs baseline correction on sample
...
#'   (`lambda`), a penalty on the value of the baseline with respect the
#'   value of the signal (`p`), and third parameter (`k`), that
#'   modifies substantially the value of (`p`) in the event of large
#'   intensity peaks.
