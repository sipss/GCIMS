...
ket1 <- findPeaks(
  ...
  debug_idx = list(rt = 1181, dt = 1502)
)
peak_list_ket1 <- peaks(ket1)
plt <- plot(ket1, dt_range = c(7, 15), rt_range = c(0, 300))
...
```{r}
plt <- plot(ket2, dt_range = c(7, 12), rt_range = c(0, 250))
plt <- add_peaklist_rect(plt, peaks(dataset), color_by = "SampleID")
plt
```
...
plt <- plot(ket2, dt_range = c(7, 12), rt_range = c(0, 200))
