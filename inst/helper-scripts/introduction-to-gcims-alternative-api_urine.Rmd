...
```{r}
ket1 <- getSample(dataset, sample = "S402_Cancer_M")
```
...
```{r}
ket1afterfilter <- getSample(dataset, sample = "S402_Cancer_M")
ket1afterfilter
```
...
ket1 <- getSample(dataset, "S402_Cancer_M")
ket1 <- findPeaks(
  ket1,
  noise_level = 3,
  rt_length_s = 3,
...
```{r}
ket2 <- getSample(dataset, "S246_Control_F")
```
...
ket1 <- getSample(dataset, "S246_Control_F")
```
