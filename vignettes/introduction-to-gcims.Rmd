...
# Reducing the size of GCIMS samples:
...
This function cuts all samples in a rectangle selected by the user. The sample cut can be performed at the beginning, but also at the end after all the pre-processing.
