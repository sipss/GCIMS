...
First of all, the directory where my samples are located is setted. After this, the folders where the samples will be stored after each preprocessing step, are created.

```{r}
setwd("C:/Users/Celia Mallafré/OneDrive - IBEC/GCIMS Work Group/Aceites/Aceites4Variedades/12.11.2020/Samples")
...
A Savitzky-Golay filter is applied for smoothing the signal. This function is teh same for retention time and for dirft time, with the difference of the by_rows parameter. When tby_rows = TRUE, the pre-processing is applied in the dirft time and by_rows = FALSE is applied in the retention time. 
